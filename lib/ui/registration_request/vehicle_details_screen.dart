...
import 'package:nilam/ui/registration_request/widgets/vehicle_request_item.dart';
import 'package:nilam/ui/update_vehicle/update_vehicle_screen.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: ListView(
            children: [
              VehicleRequestItem(status: ChipStatus.PENDING, showButton: false,),
              VSpacer10(),
              Text(
                "Vehicle Info",
